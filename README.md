...
```
variableGroups:
    - ffc-sfd-customer-receiver-payments-snd1
    - ffc-sfd-customer-receiver-payments-snd2
    - ffc-sfd-customer-receiver-payments-snd3
variables:
    - ffc-sfd-customer-receiver-payments-APPINSIGHTS-CONNECTIONSTRING
```
